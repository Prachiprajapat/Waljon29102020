...
public class ServicesListModel {
    ...
    public ServicesListModel(String image, String userimage, String price, String sample, String name, String key_id, String fav_status, String providerId, String status) {
        this.image = image;
